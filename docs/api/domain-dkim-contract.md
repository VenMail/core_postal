...
generic `Domain#as_json` output. It is returned only when
...
or be deleted through a server credential. Domains belonging to another
server are treated as not found.
