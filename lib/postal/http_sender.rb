    ...
    def parameters(message, options = {})
      ...
      when 'Hash'
        hash = {
          ...
          :from_ip => message.sender_ip,
          :source_ip => message.sender_ip,
          :dkim_signed => message.headers['dkim-signature'].present?,
          :dkim_signature => message.headers['dkim-signature']&.last,
          :headers => message.headers,
          :received_chain => Array(message.headers['received']),
