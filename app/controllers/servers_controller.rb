class ServersController < ApplicationController
  ...
  def update
    ...
    extra_params += [:send_limit, :allow_sender, :log_smtp_data, :outbound_spam_threshold, :message_retention_days, :raw_message_retention_days, :raw_message_retention_size, :block_outgoing_without_verified_route, :mailbox_domain_recipient_limit_per_minute, :mailbox_recipient_limit_per_message, :mailbox_submission_limit_per_hour, :mailbox_recipient_limit_per_day, :mailbox_hard_fail_limit_per_day] if current_user.admin?
